...
<template>
  <div class="min-h-[80vh] flex items-center justify-center px-4">
    <div class="max-w-md w-full p-8 bg-white border border-slate-200 rounded-3xl shadow-xl">
      <h2 class="text-2xl font-black text-slate-800 text-center">Create Account</h2>
      <p class="text-sm text-slate-500 text-center mt-1">
        Get started with your free notes workspace
      </p>
      ...
      <p class="mt-6 text-center text-xs text-slate-500">
        ...
        <RouterLink :to="RoutePathEnum.LOGIN" class="text-indigo-600 font-semibold hover:underline">
          Sign in
        </RouterLink>
      </p>
    </div>
